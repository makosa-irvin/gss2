    ...
    return (
      <div className="max-w-4xl mx-auto px-4 sm:px-8 py-8 space-y-8">
        <PageMeta
          ...
          type="article"
          structuredData={{
            '@context': 'https://schema.org', '@type': 'BlogPosting', headline: selectedPost.title,
            description: selectedPost.excerpt, image: selectedPost.featuredImage, datePublished: selectedPost.publishedDate,
