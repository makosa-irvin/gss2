...
export const initialTours: Tour[] = [
  {
    ...
    shortDescription: "The grand East African safari uniting Maasai Mara, Serengeti, Ngorongoro Crater, Amboseli, Lake Manyara, and Samburu in an epic two-week adventure.",
    fullDescription: "Immerse yourself in the definitive East African safari. Traverse across the savannahs of Kenya and Tanzania, tracking the Big 5, witnessing the Great Wildebeest Migration, encountering huge elephant herds beneath Mount Kilimanjaro, and descending into the geological marvel of Ngorongoro Crater with dedicated private 4x4 Land Cruisers and expert naturalist guides.",
  ...
  },
  {
    ...
    shortDescription: "Experience intimate elephant encounters and iconic panoramic views of Mount Kilimanjaro in Africa's premier elephant sanctuary.",
    fullDescription: "Journey from Nairobi into the dramatic plains of Amboseli National Park. Witness hundreds of free-ranging elephants grazing across lush swamp ecosystems directly beneath snow-capped Mount Kilimanjaro, with comfortable accommodation and private 4x4 game drives.",
    country: "Kenya",
  ...
  },
  {
    ...
    shortDescription: "A high-end safari into Africa's greatest wildlife theatre with luxury tented accommodations, private game drives, and gourmet dining.",
    fullDescription: "Experience the legendary Maasai Mara in unmatched luxury. Stay in a five-star tented camp overlooking wildlife-rich rivers, enjoy thrilling private 4x4 game drives, and witness the incredible density of lions, leopards, and millions of wildebeest.",
    country: "Kenya",
  ...
  },
  {
    ...
    shortDescription: "Encounter baby elephants at Sheldrick Wildlife Trust, hand-feed Rothschild giraffes, and enjoy a game drive in Nairobi National Park.",
    fullDescription: "Make the most of your time in Kenya's capital with this full-day adventure. Start with an early morning game drive in Nairobi National Park with city skyscrapers in the background, visit the world-famous David Sheldrick Elephant Orphanage during the 11 AM public feeding, feed endangered giraffes at the Giraffe Centre, and experience traditional dances at Bomas of Kenya.",
    country: "Kenya",
  ...
  },
  {
    ...
    shortDescription: "An exhilarating day trip from Nairobi featuring rhino sanctuaries, millions of pelicans, a boat ride on Lake Naivasha, and walking among zebras.",
    fullDescription: "Escape Nairobi for a day in the Great Rift Valley. Search for black and white rhinos at Lake Nakuru National Park, then take a boat safari on fresh-water Lake Naivasha to Crescent Island for a rare guided walking safari among zebras, giraffes, and wildebeest without predators.",
    country: "Kenya",
  ...
  },
  {
    ...
    shortDescription: "A fast-paced overnight safari designed for travelers with limited time who still want the authentic Masai Mara Big Cat experience.",
    fullDescription: "Maximize your safari time with this 2-day overnight excursion to the Masai Mara. Enjoy two extensive game drives across premier lion territories, overnight in a tented safari camp, and immerse yourself in the African bush.",
    country: "Kenya",
    destinations: ["Maasai Mara National Reserve"],
    durationDays: 2,
  ...
  },
  {
    ...
    shortDescription: "Explore northern Kenya's dramatic arid landscapes and track the Samburu Special 5 rare wildlife species.",
    fullDescription: "Samburu offers an untouched safari frontier. Spot Grevy's zebras, reticulated giraffes, gerenuks feeding on their hind legs, and enjoy luxury safari lodge comfort along the life-giving Ewaso Nyiro River.",
    country: "Kenya",
  ...
  },
  {
    ...
    shortDescription: "Exceptional wildlife viewing in Samburu with comfortable safari lodge amenities at a great value.",
    fullDescription: "A balanced safari package designed for comfort and value. Experience the rich wildlife of Samburu National Reserve without paying ultra-luxury lodge premiums.",
    country: "Kenya",
    destinations: ["Samburu National Reserve"],
    durationDays: 3,
    durationLabel: "3 Days / 2 Nights",
  ...
  },
  {
    ...
    shortDescription: "Five-star luxury safari camp experience in Amboseli with prime elephant herd positioning and views of Mount Kilimanjaro.",
    fullDescription: "Experience Amboseli in pure luxury. Stay at premier properties like Tortilis Camp or Ol Tukai, enjoy private sundowners overlooking the swamps, and witness majestic tusker elephants walking in front of Mount Kilimanjaro.",
    country: "Kenya",
    destinations: ["Amboseli National Park"],
    durationDays: 3,
    durationLabel: "3 Days / 2 Nights",
  ...
  },
  {
    ...
    shortDescription: "A great value safari adventure beneath Mount Kilimanjaro featuring extensive game drives and comfortable lodge stays.",
    fullDescription: "Experience all the wildlife wonders of Amboseli National Park with great comfort at an accessible price. Perfect for families, couples, and small groups.",
    country: "Kenya",
    destinations: ["Amboseli National Park"],
    durationDays: 3,
    durationLabel: "3 Days / 2 Nights",
  ...
  },
  {
    ...
    shortDescription: "The quintessential Bush-to-Beach adventure: 4 days of Big 5 wildlife in Masai Mara followed by 4 days of turquoise waters and luxury in Zanzibar.",
    fullDescription: "Combine the adrenaline of world-class wildlife safaris with the effortless serenity of the Indian Ocean. Track lions, leopards, and elephants in the Maasai Mara, then fly directly to the tropical paradise of Zanzibar for sunset dhow cruises, spice plantation tours, and beachfront indulgence.",
