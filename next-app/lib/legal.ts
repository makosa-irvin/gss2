...
export type LegalPageContent = {
  title: string;
  description: string;
  blocks: readonly (readonly [heading: string, body: string])[];
};
...
export const LEGAL_PAGES = {
  privacy: {
    ...
    blocks: [
      ...
      ['Analytics', 'Optional website analytics are enabled only after you choose to allow analytics. If enabled, we record page views and selected interactions against a random browser-session identifier so we can measure website growth and conversion. These analytics events are not attached to your name or email address. A configured analytics provider may also receive anonymous interaction data. You can decline analytics and still use every safari-planning and enquiry feature.'],
      ...
      ['Contact', 'For privacy questions or requests, contact Good Secrets Safaris using the email address or telephone details shown on the main website.'],
    ],
  },
  terms: {
    title: 'Website Terms',
