        ...
        {status === 'sent' ? (
          ...
          <div className="clear-both">
            ...
            <form action={submit} className="space-y-5">
              ...
              <div><label htmlFor="enquiry-notes" className={labelClass}>Anything else we should know? <span className="font-normal text-ink-muted">(optional)</span></label><textarea id="enquiry-notes" name="specialRequests" rows={3} placeholder="Celebration, accessibility, dietary needs, wildlife priorities, preferred pace..." className={`${inputClass} min-h-24`} /></div>
