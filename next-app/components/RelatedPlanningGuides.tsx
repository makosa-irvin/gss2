  ...
  return (
    <section aria-labelledby="related-planning-guides-heading" className="space-y-5">
      ...
      <div className="grid md:grid-cols-3 gap-4">
        {guides.map(item => (
          <Link key={item.slug} href={`/guides/${item.slug}`} className="group rounded-2xl border border-white/10 bg-white/5 p-5 hover:border-brand-strong hover:bg-white/[0.07] transition-colors">
